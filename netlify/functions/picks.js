  ...
  try {
    ...
    if (action === 'claude') {
      ...
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({ model: 'claude-3-5-sonnet-20241022', max_tokens: body.maxTokens || 1000, system: body.system || 'You are a helpful assistant.', messages: [{ role: 'user', content: body.prompt || 'Say hello' }] }),
      });
